  ...
  return (
    <article className="resource-article">
      ...
      {resource.media?.length ? <section className="resource-evidence" aria-labelledby="resource-evidence-title">
        <div><p>REAL SAMPLE EVIDENCE</p><h2 id="resource-evidence-title">Inspect the material and construction</h2><p>Original close-up photos from the physical Rash Guard sample. No generated product imagery is used.</p></div>
