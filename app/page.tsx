        ...
        <div className="top-picks-grid">
          {topPicks.map((product) => (
            <article className="top-pick-card" key={product.id}>
              <a className={`top-pick-image ${product.id === 'blue-team-rash-guard' || product.id === 'white-logo-rash-guard' || product.id === 'samurai-graphic-rash-guard' ? 'is-clean-product' : ''}`} href={`/products/${product.id}`} aria-label={`View ${product.name}`}>
